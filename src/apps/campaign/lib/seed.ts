...
export function buildSeedContext(project: CampaignProject, item: CampaignPlanItem): SeedContext {
  return {
    ...
    sourceDeliverableId: item.deliverableId,
    brandDnaId: project.brand.id,
    product: project.product,
    goal: project.goal,
    audience: project.audience,
    messaging: {
      promise: project.strategy.keyMessage,
      pillars: project.strategy.pillars,
      tagline: project.concept.tagline,
    },
