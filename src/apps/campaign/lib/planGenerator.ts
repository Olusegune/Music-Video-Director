...
interface PlanSeed {
  title: string;
  channel: CampaignPlanItem["channel"];
  owner: CampaignPlanItem["ownerModule"];
  offset: number;
  format: string;
}
...
export function planBlueprint(effort: CampaignEffort): PlanSeed[] {
  const core: PlanSeed[] = [
    ...
    {
      title: "Teaser social post",
      channel: "social",
      owner: "campaignstudio",
      offset: -10,
      format: "social-copy",
    },
    {
      title: "Reveal social post",
      channel: "social",
      owner: "campaignstudio",
      offset: -3,
      format: "social-copy",
  ...
  if (effort !== "small")
    core.push(
      ...
      {
        title: "Customer objection email",
        channel: "email",
        owner: "campaignstudio",
        offset: 6,
        format: "email-copy",
  ...
  if (effort === "large")
    core.push(
      {
        title: "Sustain campaign visuals",
        channel: "glam",
        owner: "glam-studio",
        offset: 7,
        format: "sustain-pack",
      ...
      {
        title: "Sustain landing-page refresh",
        channel: "web",
        owner: "webstudio",
        offset: 10,
        format: "landing-page-update",
      }
    );
  return core;
}
...
export function generatePlan(
  ...
  return planBlueprint(effort).map((seed) => {
    ...
    return {
      ...
      ownerModule: seed.owner,
      dueOffset: seed.offset,
      brief: `${strategy.keyMessage} Pillars: ${strategy.pillars.join("; ")}.`,
    };
  });
}

export function produceNativeCopy(
  title: string,
