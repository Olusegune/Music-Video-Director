...
const STYLES: Record<string, StyleVocab> = {
  "Hip Hop": {
    moves: ["bounce + groove", "two-step into a freeze", "body roll", "chest pop sequence", "footwork shuffle", "arm wave + lock", "drop to a knee slide", "shoulder bounce"],
    accents: ["hit on the snare", "freeze on the beat", "head snap", "hard lock"],
    formations: ["loose V behind the lead", "staggered line", "circle around the lead", "diagonal wedge"],
    poses: ["wide stance, arms crossed", "low crouch, fist forward", "one arm raised, head down", "lean-back silhouette"],
  },
  Afrobeats: {
    moves: ["legwork shuffle", "zanku leg swing", "waist whine", "shoulder dance (gwara)", "skip + bounce", "arm sweep", "hip sway with step", "ground tap sequence"],
    accents: ["hit on the log drum", "freeze with a smile", "shoulder pop", "leg flick"],
    formations: ["loose social circle", "two rows, call-and-response", "scattered organic group", "lead front, crew fanned out"],
    poses: ["mid-legwork freeze", "shoulders up, big grin", "arms wide, hips set", "low bounce, hands out"],
  },
  "Pop / Commercial": {
    moves: ["sharp arm choreo", "pivot step + pose", "hair flip turn", "box step", "level change", "synchronized point", "hip switch", "walk-and-pose"],
    ...
    poses: ["hand on hip, chin up", "arms framing the face", "wide power pose", "over-the-shoulder glance"],
  },
  Contemporary: {
    moves: ["reach + contract", "floor roll to rise", "spiral turn", "suspended balance", "fall and recover", "sweeping port de bras", "lunge extension", "contraction release"],
    accents: ["breath suspension", "soft freeze", "weight shift", "gaze follow"],
    formations: ["organic asymmetry", "solo with backdrop pairs", "diagonal flow", "clustered then scatter"],
    poses: ["deep lunge, arm reaching", "curled on the floor", "arabesque line", "contracted core, head bowed"],
  },
  Gospel: {
    moves: ["clap + step", "praise hands raise", "side-to-side sway", "spin into a lift", "stomp sequence", "march with claps", "joyful jump", "arm raise + reach"],
    accents: ["hit on the choir swell", "hands to the sky", "freeze in praise", "clap accent"],
    formations: ["choir rows", "semicircle around the lead", "two lines clapping", "lead front, choir tiered"],
    poses: ["both arms raised high", "head back, eyes up", "kneel with hands open", "wide embrace pose"],
  },
  "Street / Krump": {
    moves: ["chest pop + stomp", "arm swing combo", "jab sequence", "buck stomp", "power groove", "rapid arm waves", "ground get-down", "explosive jump-out"],
    accents: ["hard hit on the beat", "aggressive freeze", "chest pop accent", "stomp lock"],
    formations: ["tight cypher circle", "front line battle stance", "scattered hype crew", "lead center, crew hyping"],
    poses: ["wide buck stance, fists up", "chest out, arms flexed", "low aggressive crouch", "mid-stomp freeze"],
  },
  House: {
    moves: ["jack groove", "footwork (loft)", "skate step", "spin into shuffle", "heel-toe travel", "lofting arms", "salsa-house step", "jump kick combo"],
    accents: ["ride the bassline", "smooth freeze", "footwork accent", "spin stop"],
    formations: ["loose freestyle scatter", "loose circle", "traveling line", "lead front, crew grooving"],
    poses: ["mid-jack lean", "arms loose, head down", "wide footwork stance", "spin-out arms wide"],
  },
  "Stage / Theatrical": {
    moves: ["dramatic walk + turn", "fan kick", "tableau pose change", "grand gesture sweep", "level cascade", "spotlight step-out", "ensemble unison hit", "dramatic reach"],
    accents: ["hit on the orchestral stab", "tableau freeze", "spotlight pose", "unison snap"],
    formations: ["symmetrical ensemble", "tiered staging", "lead downstage, ensemble back", "diagonal grand line"],
    poses: ["grand arms-wide finish", "dramatic reach to the light", "tableau group freeze", "spotlight power pose"],
  },
};
...
export function deleteChoreo(songId: string): void {
  localStorage.setItem(
    LS_CHOREO,
    JSON.stringify(loadAll().filter((c) => c.songId !== songId))
  );
}
