...
export const MODEL_REGISTRY: ModelVariant[] = [
  ...
  v({
    ...
    kind: "image",
    aggregator: true,
    workflows: ["text-to-image", "image-to-image", "character-ref", "style-ref", "upscale"],
    capabilities: ["High quality", "Character ref"],
  }),
  v({
    id: "fal:flux-ultra",
    provider: "Fal.ai",
    ...
    kind: "image",
    aggregator: true,
    workflows: ["text-to-image", "image-to-image", "style-ref", "upscale"],
    capabilities: ["Max quality", "Upscale"],
  }),
  v({
    id: "fal:flux-kontext",
    provider: "Fal.ai",
    ...
    kind: "image",
    aggregator: true,
    workflows: ["image-to-image", "character-ref"],
    capabilities: ["Character consistency"],
  }),
  v({
    id: "grok:image",
    provider: "Grok / xAI",
    ...
    kind: "image",
    available: true,
    workflows: ["text-to-image", "variation"],
  ...
  v({
    ...
    variant: "v3",
    kind: "image",
    workflows: ["text-to-image", "style-ref"],
    capabilities: ["Vector / design"],
  }),
  v({
    id: "ideogram:v2",
    provider: "Ideogram",
  ...
  v({
    ...
    aggregator: true,
    workflows: ["text-to-video", "image-to-video"],
    capabilities: ["Fast draft", "Lower cost"],
  }),
  v({
    ...
    capabilities: ["Fastest preview", "Short clips"],
  }),
  v({
    id: "kie:kling-pro",
    provider: "Kie AI",
  ...
  for (const m of MODEL_REGISTRY) {
    ...
    if (!p) {
      p = {
        id: m.providerKey,
        label: m.provider,
        kind: m.aggregator ? "aggregator" : "direct",
        variants: [],
      };
...
export function variantsForWorkflow(
  wf: Workflow,
  opts?: { availableOnly?: boolean }
): ModelVariant[] {
  return MODEL_REGISTRY.filter(
    (m) => m.workflows.includes(wf) && (!opts?.availableOnly || m.available)
  );
}
