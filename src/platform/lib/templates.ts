...
export const TEMPLATES: MvTemplate[] = [
  ...
  T({
    ...
    locations: ["sun-soaked rooftop", "vibrant market street", "palm courtyard at golden hour", "neon-lit night block"],
  ...
  T({
    ...
    locations: ["raw concrete warehouse", "night city block", "rooftop skyline", "luxury penthouse"],
  ...
  T({
    ...
    locations: ["pastel infinity set", "neon concept room", "all-white studio cyc", "mirror-lined room"],
    wardrobePool: ["coordinated high-fashion set", "monochrome concept fit", "pastel statement look"],
    cutBias: 0.8,
    lean: "performance",
  }),
  T({
    ...
    locations: ["light-filled church", "open field at sunrise", "grand hall with windows", "candlelit room"],
  ...
  T({
    ...
    locations: ["neon-lit apartment at night", "rain-slick street", "dim hotel room", "car at night"],
  ...
  T({
    ...
    locations: ["night street party", "beach at dusk", "yard with sound system", "neon club exterior"],
  ...
  T({
    ...
    locations: ["neon nightclub", "rooftop pool at night", "chrome penthouse", "exotic car at night"],
  ...
  T({
    ...
    locations: ["festival main stage", "laser-filled warehouse", "abstract LED void", "crowd at the drop"],
  ...
  T({
    ...
    recommendedProviders: ["Veo / fal (clips)", "Imagen (frames)"],
    locations: ["hazy worship stage", "modern sanctuary", "mountain vista at dawn", "candlelit hall"],
  ...
  T({
    ...
    locations: ["coast at blue hour", "rain-streaked window", "empty city at dusk", "quiet home interior"],
  ...
  T({
    ...
    locations: ["anime city rooftop at dusk", "cherry-blossom street", "neon anime alley", "vast anime sky"],
  ...
  T({
    ...
    locations: ["flat illustrated city", "pattern backdrop", "paper-cut landscape", "graphic stage"],
  ...
  T({
    ...
    locations: ["stylized 3D town", "fantastical set-piece", "cozy rendered interior", "vast CG vista"],
  ...
  T({
    ...
    recommendedProviders: ["Kling / fal (clips)", "Nano Banana Pro (frames)"],
    locations: ["neon sci-fi temple", "chrome void stage", "holographic throne room", "futuristic skyline"],
  ...
  T({
    ...
    recommendedProviders: ["fal / Kling (clips)", "Imagen / GPT Image (frames)"],
    locations: ["haze-filled soundstage", "single bold-color cyc", "striking real location", "dark void with light"],
...
export function deleteCustomTemplate(id: string): void {
  localStorage.setItem(
    LS_CUSTOM,
    JSON.stringify(loadCustomTemplates().filter((t) => t.id !== id))
  );
}
