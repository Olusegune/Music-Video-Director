...
import { formatTime, sectionColor, SECTION_KINDS, type SongSection, type SectionKind } from "@/lib/songBrain";
import { detectSectionPerformer, SECTION_PERFORMER_ROLES } from "@/lib/performerDetect";
