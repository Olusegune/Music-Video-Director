...
import { formatTime, sectionColor, type SongMap, type SongSection, type LyricLine } from "@/lib/songBrain";
import { detectSectionPerformer, detectAllPerformers } from "@/lib/performerDetect";
