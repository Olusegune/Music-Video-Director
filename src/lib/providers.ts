...
export const PROVIDERS: ProviderInfo[] = [
  // Text / reasoning
  { id: "gemini", name: "Google Gemini", capabilities: ["text"], quality: 5, speed: 4, cheap: 4, hint: "AI Studio API key", status: "wired" },
  { id: "openai", name: "OpenAI", capabilities: ["text", "image"], quality: 5, speed: 4, cheap: 3, hint: "OpenAI API key (GPT Image wired)", status: "wired" },
  ...
  { id: "google_imagen", name: "Google Imagen", capabilities: ["image"], quality: 4, speed: 4, cheap: 4, hint: "Google API key", status: "wired" },
  { id: "nano_banana", name: "Nano Banana", capabilities: ["image"], quality: 4, speed: 4, cheap: 4, hint: "Gemini image workflow", status: "planned" },
  { id: "nano_banana_pro", name: "Nano Banana Pro", capabilities: ["image"], quality: 5, speed: 3, cheap: 3, hint: "Gemini Pro image workflow", status: "planned" },
